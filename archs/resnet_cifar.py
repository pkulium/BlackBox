...
class ResNet_backdoored(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, norm_layer=None):
        super(ResNet_backdoored, self).__init__()
...
def resnet18_backdoored(num_classes=10, norm_layer=nn.BatchNorm2d):
    return ResNet_backdoored(BasicBlock, [2, 2, 2, 2], num_classes, norm_layer)


def resnet34(num_classes=10, norm_layer=nn.BatchNorm2d):
    return ResNet_backdoored(BasicBlock, [3, 4, 6, 3], num_classes, norm_layer)


def resnet50(num_classes=10, norm_layer=nn.BatchNorm2d):
    return ResNet_backdoored(Bottleneck, [3, 4, 6, 3], num_classes, norm_layer)


def resnet101(num_classes=10, norm_layer=nn.BatchNorm2d):
    return ResNet_backdoored(Bottleneck, [3, 4, 23, 3], num_classes, norm_layer)


def resnet152(num_classes=10, norm_layer=nn.BatchNorm2d):
    return ResNet_backdoored(Bottleneck, [3, 8, 36, 3], num_classes, norm_layer)
